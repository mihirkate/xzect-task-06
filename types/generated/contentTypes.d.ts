...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    PublishedDate: Attribute.DateTime &
      Attribute.Required &
      Attribute.DefaultTo<'2024-06-23T18:45:00.000Z'>;
...
export interface ApiGalleryGallery extends Schema.CollectionType {
  ...
  attributes: {
    CreatedAtWHat: Attribute.DateTime;
    Images: Attribute.Media<'images'>;
    Videos: Attribute.Media<'videos'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String & Attribute.Required;
    Descrption: Attribute.String & Attribute.Required;
    images: Attribute.Media<'images'> & Attribute.Required;
    Articles: Attribute.Text & Attribute.Required;
...
export interface ApiShopShop extends Schema.CollectionType {
  ...
  attributes: {
    shopId: Attribute.UID<'api::shop.shop', 'ProductDetails'> &
      Attribute.Required;
    checkOut: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ProductDetails: Attribute.String & Attribute.Required & Attribute.Unique;
    checkOutTime: Attribute.DateTime & Attribute.Required;
